	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="{{url('/dashboard')}}"><span>Metro</span></a>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown hidden-phone">
							...
							<ul class="dropdown-menu messages">
                            	...
                            	<li>
                                    <a href="#">
										<span class="avatar"><img src="{{asset('public/admin_asset/img/avatar.jpg')}}" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Dennis Ji
										     </span>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{url('/manage-category')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Category</span></a></li>
						<li><a href="{{url('/manage-sub-category')}}"><i class="icon-tasks"></i><span class="hidden-tablet">Sub Categories</span></a></li>
						<li><a href="{{url('/manage-brand')}}"><i class="icon-tasks"></i><span class="hidden-tablet">Brands</span></a></li>
						<li><a href="{{url('/add-product')}}"><i class="icon-list-alt"></i><span class="hidden-tablet">Add Products</span></a>
						</li>
						<li><a href="{{url('/manage-product')}}"><i class="icon-list-alt"></i><span class="hidden-tablet">Manage Products</span></a>
						</li>
